...
function IrpProducts() {
  ...
  const [_irpAccountInfo, setIrpAccountInfo] = useState<any>(null);
  ...
  // const _handleConsultationClick = () => {
  ...
  // 리스크 타입을 투자 스타일로 매핑
  const mapRiskTypeToInvestmentStyle = (riskType: string): 'STABLE' | 'STABLE_PLUS' | 'NEUTRAL' | 'AGGRESSIVE' => {
    switch (riskType) {
      case 'STABLE':
        return 'STABLE';
      case 'STABLE_PLUS':
                  ...
                  <div className="space-y-6 max-w-lg mx-auto">
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg text-left">
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        {riskProfileResult.riskProfileType === 'STABLE' && (
                          <>
                        ...
                        {riskProfileResult.riskProfileType === 'STABLE_PLUS' && (
                          <>
                        ...
                        {riskProfileResult.riskProfileType === 'NEUTRAL' && (
                          <>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="font-hana-medium text-gray-800">
                      {createdAccountInfo.investmentStyle === 'STABLE' && '안정형'}
                      {createdAccountInfo.investmentStyle === 'STABLE_PLUS' && '안정추구형'}
                      {createdAccountInfo.investmentStyle === 'NEUTRAL' && '중립형'}
                      {createdAccountInfo.investmentStyle === 'AGGRESSIVE' && '적극형'}
                    </span>
                  </div>
                </div>
              </div>
